...
| Raw WP | 可复用联系 |
|---|---|
| [RCTF2025-514-wp](../raw/web/RCTF2025-514-wp.md) | Koishi 插件把 text 写进 Puppeteer 渲染页，`file://` origin 允许 iframe 指向本地 flag；payload 重点是绕过 `/` 转义并把 iframe 覆盖到 canvas 上。 |
...
- [RCTF2025-514-wp.md](../raw/web/RCTF2025-514-wp.md)
