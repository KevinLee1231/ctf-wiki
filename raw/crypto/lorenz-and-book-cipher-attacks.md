# CTF Crypto - Lorenz and Book Cipher Attacks
...
**模式（Booking Key）：** Book cipher encodes password as list of "steps forward" in reference text.

**关键结论：** Charset constraint drastically reduces candidate starting positions:
```python
