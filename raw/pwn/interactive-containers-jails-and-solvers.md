...
- 如果只是轻量 recurrence 或自适应查询 oracle，转 [algorithmic-oracles-and-linear-recurrences.md](../crypto/algorithmic-oracles-and-linear-recurrences.md)；本卷保留复杂交互协议、容器和 jail 长链。
