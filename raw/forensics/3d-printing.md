...
**模式（PrintedParts）：** Plot X vs Z (side view) with Y filtering. Extrusion segments at specific Y ranges form readable text.
...
**关键结论：** G-code is just coordinate lists. Side projections (XZ or YZ) reveal embossed/engraved text.
